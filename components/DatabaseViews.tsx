...
import { formatPriority, modifiedSpeed, priorityMatches, totalBaseStats } from "../lib/domain";
  ...
  return <>
    <section className="panel">
      ...
      <div className="advanced-filters">
        ...
        <div className="filter-actions"><button type="button" className="filter-chip clear-filters" onClick={clearFilters}>{locale === "zh-Hant" ? "清除招式篩選" : "Clear move filters"}</button></div>
      </div>
...
export function SpeedCompareV2({ locale, format = "doubles", active = true }: { locale: Locale; format?: BattleFormat; active?: boolean }) {
